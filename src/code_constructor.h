...
#define GENERATE_1(name) generate_##name(constructor->generator)
#define GENERATE_2(name, op0) generate_##name(constructor->generator, op0)
#define GENERATE_3(name, op0, op1) generate_##name(constructor->generator, op0, op1)
#define GENERATE_4(name, op0, op1, op2) generate_##name(constructor->generator, op0, op1, op2)
